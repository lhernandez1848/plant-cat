    ...
    <section className="">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <a href="/care" className="inline-flex items-center justify-center px-8 py-3 text-base font-medium text-center text-teal-800 bg-teal-100 hover:bg-teal-300 rounded-lg focus:ring-4 focus:ring-gray-100">
            Care Tips
          </a> 
        </div>
