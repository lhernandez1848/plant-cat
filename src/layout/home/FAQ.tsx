...
export default async function FAQ() {
  ...
  return (
    <section className="grid max-w-screen-xl px-4 py-10 mx-auto lg:gap-8 xl:gap-0 lg:py-16">
      ...
      <p className="text-gray-500 mb-10">Wondering how to help your plants thrive? Explore our most common questions and discover tips from fellow plant enthusiasts.</p>
