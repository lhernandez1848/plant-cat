      ...
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <a href="/home" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
            <span className="text-heading self-center text-2xl font-semibold whitespace-nowrap text-teal-900 logo-font">Little Leaf</span>
          </a>
        ...
        <span className="block text-sm text-body sm:text-center text-gray-800">© {new Date().getFullYear()} Little Leaf. All rights reserved.</span>
      </div>
    </footer>
  );
}